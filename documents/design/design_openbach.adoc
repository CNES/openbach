...
displaying the statistics/data and the log messages, are detailed 
<<user-content-display-of-data-collection,after the description design of the Collector
...
installing new Agents is explained in section link:../../src/auditorium/README.md#manage-agents[Manage agents].
...
operations on the collected data via the post-processing jobs is shown
