...
jf("/website_cnes/static.doubleclick.net/instream/ad_status.js",a);uf.push(rf(function(){vf||"google_ad_status"in window||(pf("/website_cnes/static.doubleclick.net/instream/ad_status.js",a),vf=!0,N("DCLKSTAT",3))},5E3))}}
...
b=Ce("/website_cnes/googleads.g.doubleclick.net/pagead/id.json",a)}),function(c){c instanceof vd&&b.abort();
return sd(c)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&Bf.dispose();a=0;for(var b=uf.length;a<b;a++){var c=uf[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}uf.length=0;of("/website_cnes/static.doubleclick.net/instream/ad_status.js");vf=!1;N("DCLKSTAT",0);Uc(Zi,Yi);if(a=Xi)a.removeEventListener("onScreenChanged",bj),a.removeEventListener("onLogClientVeCreated",aj),a.removeEventListener("onLogServerVeCreated",cj),a.removeEventListener("onLogVeClicked",dj),a.removeEventListener("onLogVesShown",
ej),a.destroy();$i={}});
